<!-- <script setup lang="ts" generic="T extends TableItem<any>"> -->
    ...
    <div class="flex flex-col gap-[1rem]">
        ...
        >
            ...
            <table :id="tableElementId" :class="tableClasses">
                ...
                >
                    ...
                    <template v-for="(row, index) of tableData" :key="index">
                        <!-- draggable="true" -->
                        <tr
                            :id="`row-${index}`"
                            ref="itemRefs"
                        ...
                        >
                            ...
                            <template v-else-if="checkIfChildrenExists(columns)">
                                ...
                                >
                                    ...
                                    <span
                                        v-else
                                        :style="isElementDisabled(columnRow.style)"
        ...
        >
            <edc-dropdown
                ...
                @on-select="(selectedOptions) => handlePageLimit(selectedOptions)"
            />
