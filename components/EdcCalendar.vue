<script setup lang="ts">
    ...
    // const getInputClass = () =>
    //     `input-font outline-none date-selection-container w-[90%] ${props.inputClass}`.trim();

    // const isUnknownDateAndMonthAllowed = computed(() => {
    //     let seperationCharacter = "";
    //     if (String(props.format).includes("-")) seperationCharacter = "-";
    //     else if (String(props.format).includes("/")) seperationCharacter = "/";
    //     else if (String(props.format).includes(" ")) seperationCharacter = " ";
    //     const result = {
    //         date: false,
    //         month: false,
    //         seperationCharacter,
    //     };
    //     const [dateFormat = "", monthFormat = ""] = String(props.format).split(seperationCharacter);
    //     if (dateFormat.includes("?")) result.date = true;
    //     if (monthFormat.includes("?")) {
    //         result.month = true;
    //         monthsList.value.push("Unknown");
    //     }
    //     console.log("result in isUnknownDateAllowed", result);
    //     return { ...result };
    // });
    // const seperatedFormat = computed(() => {
    //     // const result = {
    //     //     dateFormat: "",
    //     //     monthFormat: "",
    //     //     yearFormat: "",
    ...
    //     //     secondFormat: "",
    //     // };
    //     // if (isUnknownDateAndMonthAllowed.value.seperationCharacter === " ") {
    //     //     const [firstFormat = "", secondFormat = "", thirdFormat = "", timeFormat = ""] = props.format.split(isUnknownDateAndMonthAllowed.value.seperationCharacter);
    //     //     if (timeFormat) {
    //     //         const [hourFormat, minuteFormat, secondsFormat] = timeFormat.split(":");
    //     //         result.hourFormat = hourFormat;
    //     //         result.minuteFormat = minuteFormat;
    //     //         result.secondFormat = secondsFormat;
    //     //     } else {
    //     //         result.dateFormat = firstFormat;
    //     //         result.monthFormat = secondFormat;
    //     //         result.yearFormat = thirdFormat;
    //     //     }
    //     // } else {
    //     //     const [firstFormat = "", secondFormat = "", thirdFormat = "", timeFormat = ""] = props.format.split(isUnknownDateAndMonthAllowed.value.seperationCharacter);
    //     //     if (timeFormat) {
    ...
    //     let dateYearFormat = "";
    //     let dateHourFormat = "";
    //     let dateMinuteFormat = "";
    //     let dateSecondFormat = "";
    //     if (isUnknownDateAndMonthAllowed.value.seperationCharacter) {
    //         const [firstFormat = "", secondFormat = "", thirdFormat = "", fourthFormat = ""] =
    //             correctDateTimeFormat.value.split(
    //                 isUnknownDateAndMonthAllowed.value.seperationCharacter,
    //             );

    //         if (fourthFormat) {
    //             const [firstSubFormat = "", secondSubFormat = "", thirdSubFormat = ""] =
    //                 fourthFormat.split(":");
    //             if (firstFormat.toLowerCase().includes("d")) dateDayFormat = firstFormat;
    //             else if (secondFormat.toLowerCase().includes("d")) dateDayFormat = secondFormat;
    //             else dateDayFormat = thirdFormat;
    //             if (firstFormat.toLowerCase().includes("m")) dateMonthFormat = firstFormat;
    //             else if (secondFormat.toLowerCase().includes("m")) dateMonthFormat = secondFormat;
    //             else dateMonthFormat = thirdFormat;
    //             if (firstFormat.toLowerCase().includes("y")) dateYearFormat = firstFormat;
    //             else if (secondFormat.toLowerCase().includes("y")) dateYearFormat = secondFormat;
    //             else dateYearFormat = thirdFormat;
    //             dateHourFormat = firstSubFormat;
    //             dateMinuteFormat = secondSubFormat;
    //             dateSecondFormat = thirdSubFormat;
    //         } else {
    //             const [firstSubFormat = "", secondSubFormat = ""] = thirdFormat.split(" ");
    //             const [
    //                 firtNestedSubFormat = "",
    //                 secondNestedSubFormat = "",
    //                 thirdNestedSubFormat = "",
    //             ] = secondSubFormat.split(":");
    //             if (firstFormat.toLowerCase().includes("d")) dateDayFormat = firstFormat;
    //             else if (secondFormat.toLowerCase().includes("d")) dateDayFormat = secondFormat;
    //             else dateDayFormat = firstSubFormat;
    //             if (firstFormat.toLowerCase().includes("m")) dateMonthFormat = firstFormat;
    //             else if (secondFormat.toLowerCase().includes("m")) dateMonthFormat = secondFormat;
    //             else dateMonthFormat = firstSubFormat;
    //             if (firstFormat.toLowerCase().includes("y")) dateYearFormat = firstFormat;
    //             else if (secondFormat.toLowerCase().includes("y")) dateYearFormat = secondFormat;
    //             else dateYearFormat = firstSubFormat;
    //             dateHourFormat = firtNestedSubFormat;
    //             dateMinuteFormat = secondNestedSubFormat;
    //             dateSecondFormat = thirdNestedSubFormat;
    //         }
    //     } else {
    //         const [firstFormat = "", secondFormat = "", thirdFormat = ""] =
    //             correctDateTimeFormat.value.split(":");
    //         dateDayFormat = "";
    //         dateMonthFormat = "";
    //         dateYearFormat = "";
    //         dateHourFormat = firstFormat;
    //         dateMinuteFormat = secondFormat;
    //         dateSecondFormat = thirdFormat;
    //     }
    //     return [
    //         dateDayFormat,
    //         dateMonthFormat,
    ...
    //     ];
    // });
    // const correctDateTimeFormat = computed(() => {
    //     let result = props.format;
    //     if (props.format.includes("?")) result = props.format.replaceAll("?", "") as TDateFormat;
    //     return result;
    // });
    ...
    //     for (let i = 1; i <= numberOfDaysInMonth(selectedDate.value); i++) {
    ...
    //             disabled: false,
    //         });
    //     console.log("result in currentDaysList", result);
    ...
    //         "month",
    //     );
    //     console.log("previousMonth in previousMonthDays computed", previousMonth);
    //     console.log(
    //         "firstDayOfTheMonthWeekday in previousMonthDays computed",
    ...
    //     //     : 6;
    //     // const previousMonthLastMondayDayOfMonth = subtractDate(
    //     //     currentMonthDays.value[0].date,
    //     //     visibleNumberOfDaysFromPreviousMonth,
    //     //     "day",
    //     // ).date();
    //     // console.log("previousMonthLastMondayDayOfMonth", previousMonthLastMondayDayOfMonth);
    //     // const result: IDay[] = [];
    //     // for (let i = 1; i <= previousMonthLastMondayDayOfMonth; i++) {
    //     // const date = `${previousMonth.year()}-${previousMonth.month() + 1}-${previousMonthLastMondayDayOfMonth + i}`;
    //     // result.push({
    ...
    //     console.log(
    //         "visibleNumberOfDaysFromPreviousMonth in previousMonthDays computed",
    //         visibleNumberOfDaysFromPreviousMonth,
    //     );
    //     const previousMonthLastDayOfMonth = subtractDate(
    //         `${previousMonth.year()}-${previousMonth.month() + 1}-01`,
    //         1,
    //         "day",
    //     ).date();
    //     console.log(
    //         "previousMonthLastDayOfMonth in previousMonthDays computed",
    //         previousMonthLastDayOfMonth,
    //     );
    //     const result: IDay[] = [];
    //     for (let i = 0; i < firstDayOfTheMonthWeekday; i++) {
    //         const date = `${previousMonth.year()}-${previousMonth.month() + 1}-${
    //             previousMonthLastDayOfMonth - (visibleNumberOfDaysFromPreviousMonth - 1 - i)
    //         }`;
    //         result.push({
    ...
    //         });
    //     }
    //     console.log("result in previousMonthDays computed", result);
    //     return deepClone(result) as IDay[];
    // });
    const previousMonthDays = computed(() => {
        const firstDayOfTheMonthWeekday = weekDay(currentMonthDays.value[0].date);
        ...
        // ).date();
        // console.log(
        //     "previousMonthLastMondayDayOfMonth in previousMonthDays computed",
        ...
        for (let i = 0; i < firstDayOfTheMonthWeekday; i++) {
            // const date = `${previousMonth.year()}-${previousMonth.month() + 1}-${previousMonthLastMondayDayOfMonth + i}`;
            // const date = `${previousMonth.year()}-${previousMonth.month() + 1}-${previousMonthLastDayOfMonth - (visibleNumberOfDaysFromPreviousMonth - 1 - i)}`;
    ...
    //     const lastDayOfTheMonthWeekday = weekDay(
    //         `${selectedYear.value}-${selectedMonth.value}-${getArrayLength(currentMonthDays.value)}`,
    //     );
    //     const nextMonth = addDate(`${selectedYear.value}-${selectedMonth.value}-01`, 1, "month");
    //     console.log("nextMonth in nextMonthDays computed", nextMonth);
    //     // const visibleNumberOfDaysFromNextMonth = lastDayOfTheMonthWeekday
    //     //     ? 7 - lastDayOfTheMonthWeekday
    //     //     : lastDayOfTheMonthWeekday;

    //     // const result: IDay[] = [];
    //     // for (let i = 1; i <= visibleNumberOfDaysFromNextMonth; i++) {
    //     //     const date = `${nextMonth.year()}-${nextMonth.month() + 1}-${i + 1}`;
    //     //     result.push({
    //     //         date: formatDate(date),
    //     //         isCurrentMonth: false,
    //     //         isToday: false,
    ...
    //     // }
    //     // return deepClone(result) as IDay[];
    //     console.log("lastDayOfTheMonthWeekday in nextMonthDays computed", lastDayOfTheMonthWeekday);
    //     const visibleNumberOfDaysFromNextMonth =
    //         lastDayOfTheMonthWeekday === 0
    //             ? // ? 7 - lastDayOfTheMonthWeekday
    //               // : lastDayOfTheMonthWeekday;
    //               lastDayOfTheMonthWeekday
    //             : 7 - lastDayOfTheMonthWeekday;
    ...
    //     console.log(
    //         "visibleNumberOfDaysFromNextMonth in nextMonthDays computed",
    ...
    //         });
    //     }
    //     console.log("result in nextMonthDays computed", result);
    //     return deepClone(result) as IDay[];
    // });
    const nextMonthDays = computed(() => {
        // Get the last day of the current month and its weekday
        // const lastDayOfTheMonth = currentMonthDays.value[currentMonthDays.value.length - 1].date;
        // const lastDayOfTheMonthWeekday = weekDay(lastDayOfTheMonth); // Get weekday of last day of the current month
        ...
        // Calculate how many days we need from the next month to fill the calendar row
        // const visibleNumberOfDaysFromNextMonth =
        //     lastDayOfTheMonthWeekday === 0
        //         ? 7 // If last day is Sunday, we need 7 days from next month
        //         : 7 - lastDayOfTheMonthWeekday; // Otherwise, calculate based on the last day weekday

        const result: IDay[] = [];

        // Loop to get the correct number of days from the next month
    ...
    // const checkIfDateIsDisabled = (day) =>
    ...
    //     () => hours.value,
    //     (newHours) => {
    //         let finalResult = newHours;
    //         if (!checkIfValidNumber(newHours)) finalResult = null;
    //         else if (!newHours) finalResult = null;
    //         else if (newHours === "-") finalResult = null;
    //         else if (newHours && (Number(newHours) < 1 || Number(newHours) > 12)) {
    //             finalResult = null;
    //         }
    //         hours.value = finalResult;
    //         if (!finalResult && newHours) {
    //             toastStore.error({
    ...
    //     () => minutes.value,
    //     (newMinutes) => {
    //         let finalResult = newMinutes;
    //         if (!checkIfValidNumber(newMinutes)) finalResult = null;
    //         else if (!newMinutes) finalResult = null;
    //         else if (newMinutes === "-") finalResult = null;
    //         else if (newMinutes && (Number(newMinutes) < 1 || Number(newMinutes) > 59)) {
    //             finalResult = null;
    //         }
    //         minutes.value = finalResult;
    //         if (!finalResult && newMinutes) {
    //             toastStore.error({
    ...
    //     const result: IDay[] = [];
    //     for (let i = 1; i <= numberOfDaysInMonth("2024-03-25"); i++) {
    //         // result.push(String(i).padStart(2));
    //         const date = `${selectedYear.value}-${selectedMonth.value}-${i}`;
    //         result.push({
    //             date: formatDate(date),
    //             isCurrentMonth: true,
    //             isToday: isTodayDate(date),
    //         });
    //     }
    //     daysList.value = deepClone(result) as IDay[];
    // }
    ...
    //     function processDateTime(dateTime: string) {
    //         const [firstValue = "", secondValue = "", thirdValue = "", fourthValue = ""] = String(modelValue.value).split(dateTimeFormatDetails.value.seperator.date);
    ...
    //     ? `${selectedYear.value}-${selectedMonth.value}-UN`
    ...
    // console.log("modelValue.value in edcdropdown nested if", modelValue.value);
    // console.log("params alt ref in onMounted", [
    //     selectedYear.value,
    //     selectedMonth.value,
    //     selectedDate.value,
    //     hourState.value,
    ...
    //         // selectedMonth.value = Number(formatDate(props.modelValue, "M"));
    //         // selectedYear.value = formatDate(props.modelValue, "YYYY");
    //         // For adding utc timezone
    //         // const timeInUTC = `${modelValue.value}Z`;
    //         // modelValue.value = timeInUTC;
    //         // originalValue.value = timeInUTC;
    //         // For adding utc timezone
    //         originalValue.value = modelValue.value;
    //         selectedMonth.value = Number(formatDate(modelValue.value, "M"));
    //         selectedYear.value = formatDate(modelValue.value, "YYYY");
    //         console.log("modelValue.value in edcdropdown", modelValue.value);
    //         // console.log("timeInUTC in edcdropdown", timeInUTC);
    ...
    onMounted(() => {
        if (modelValue.value) {
            ...
            // secondState.value = secondsValue;
            // if (
            //     isUnknownDateAndMonthAllowed.value.date ||
            //     isUnknownDateAndMonthAllowed.value.month
            // ) {
            ...
            //     selectedMonth.value = Number(formatDate(modelValue.value, "M"));
            //     selectedYear.value = formatDate(modelValue.value, "YYYY");
            //     console.log("modelValue.value in edcdropdown nested else", modelValue.value);
            //     // console.log("timeInUTC in edcdropdown", timeInUTC);
            //     const [hoursValue, minutesValue, secondsValue] = formatDate(
            //         modelValue.value, // timeInUTC,
            //         "HH:mm:ss",
            ...
            if (props.type === "time") {
                ...
                // selectedYear.value = formatDate(todayDate, "YYYY");
                // selectedMonth.value = Number(formatDate(todayDate, "M"));
                // const selectedDateRef = Number(formatDate(todayDate, "D"));
                // hourState.value = hourValueRef;
                // minuteState.value = minuteValueRef;
                // secondState.value = secondValueRef;
                // const modelRef = `${selectedYear.value}-${selectedMonth.value}-${selectedDateRef} ${hourState.value}:${minuteState.value}:${secondState.value}`;
                // modelValue.value = modelRef;
                // originalValue.value = modelRef;
                const [dateValue = "", monthValue = "", yearValue = ""] = String(
                    formatterModelValue,
                ).split(dateTimeFormatDetails.value.seperator.date || "-");
                const [correctYear = "", timeValue = ""] = String(yearValue).split(" ");
    ...
    // function onScroll() {
    //     console.log("scrolling in onScroll");
    //     calculateFloatingElementBounding();
    // }

    // onMounted(() => {
    //     console.log("modelValue.value in onMounted start", modelValue.value);
    //     if (modelValue.value) {
    //         // modelValue.value = props.modelValue;
    //         // selectedMonth.value = Number(formatDate(props.modelValue, "M"));
    //         // selectedYear.value = formatDate(props.modelValue, "YYYY");
    ...
    //         // For adding utc timezone
    //         console.log(
    //             "isUnknownDateAndMonthAllowed.value in onMounted",
    //             isUnknownDateAndMonthAllowed.value,
    //         );
    //         console.log("seperatedFormat.value in onMounted", seperatedFormat.value);
    //         // if (
    //         //     isUnknownDateAndMonthAllowed.value.date ||
    //         //     isUnknownDateAndMonthAllowed.value.month
    //         // ) {
    ...
    //         const [dateValue = "", monthValue = "", yearValue = "", timeValue = ""] = String(
    //             modelValue.value,
    //         ).split(isUnknownDateAndMonthAllowed.value.seperationCharacter);
    //         if (timeValue) {
    //             const [hourValue = "", minuteValue = "", secondValue = ""] = timeValue.split(":");
    //             dateValueRef = getStringLength(dateValue) === 4 ? yearValue : dateValue;
    //             monthValueRef = monthValue;
    ...
    //         selectedYear.value = formatDate(yearValueRef, "YYYY");
    //         originalValue.value = modelValue.value;
    //         selectedMonth.value = isUnknownDateAndMonthAllowed.value.month
    //             ? 13
    //             : Number(formatDate(`${yearValueRef}-${monthValueRef}-01`, "M"));
    //         // const selectedDateRef = isUnknownDateAndMonthAllowed.value.date ? "UN" : Number(formatDate(`${yearValueRef}-${monthValueRef}-${dateValueRef}`, "D"));
    //         selectedDate.value = isUnknownDateAndMonthAllowed.value.date
    //             ? `${selectedYear.value}-${selectedMonth.value}-UN`
    //             : formatDate(`${yearValueRef}-${monthValueRef}-${dateValueRef}`, "YYYY-MM-DD");
    //         hourState.value = hourValueRef;
    //         minuteState.value = minuteValueRef;
    ...
    //         modelValue.value = `${selectedYear.value}-${selectedMonth.value}-${selectedDate.value} ${hourState.value}:${minuteState.value}:${secondState.value}`;
    //         console.log("modelValue.value in edcdropdown nested if", modelValue.value);
    //         console.log("params ref in onMounted", [
    //             dateValueRef,
    //             monthValueRef,
    //             yearValueRef,
    //             hourValueRef,
    ...
    //     monthState.value = monthsList.value[Number(selectedMonth.value) - 1];
    //     // setDaysList();
    //     console.log("originalValue in onMounted last", originalValue.value);
    //     console.log("modelValue in onMounted last", modelValue.value);
    //     debugger;
    // });
</script>
...
<template>
    <div :class="containerClasses">
        ...
        <!-- <div v-else ref="calendarPickerContainer" class="relative calendar-container">
            <input
                :id="getInputId()"
                :value="getInputValue"
                type="text"
